...
Klassikale multiplechoice met antwoordkaarten: leerlingen houden een kaart omhoog, de camera
van de laptop herkent het antwoord aan de draairichting. Alles draait op je eigen laptop;
...
## Kaarten
De antwoordkaarten (PDF, één per A4) staan bij elke versie hieronder als download
(`cardturnup_kaarten_50_A4.pdf`).

Alle versies: [Releases](https://github.com/HPDesignJetZ9/card-turn-up-releases/releases)
